...
class Ui_ServerSettingsDialog(object):
    def setupUi(self, ServerSettingsDialog):
        if not ServerSettingsDialog.objectName():
            ServerSettingsDialog.setObjectName(u"ServerSettingsDialog")
        ...
        self.lineEdit_host.setStyleSheet(u"border: 1px solid black;")

        self.formLayout_general_settings.setWidget(0, QFormLayout.FieldRole, self.lineEdit_host)
        ...
        self.lineEdit_port.setStyleSheet(u"border: 1px solid black;")

        self.formLayout_general_settings.setWidget(1, QFormLayout.FieldRole, self.lineEdit_port)
    ...
    def retranslateUi(self, ServerSettingsDialog):
        ServerSettingsDialog.setWindowTitle(QCoreApplication.translate("ServerSettingsDialog", u"Dialog", None))
        self.label.setText(QCoreApplication.translate("ServerSettingsDialog", u"Host", None))
        self.label_2.setText(QCoreApplication.translate("ServerSettingsDialog", u"Port: ", None))
        self.pushButton_apply.setText(QCoreApplication.translate("ServerSettingsDialog", u"&Apply", None))
        self.pushButton_cancel.setText(QCoreApplication.translate("ServerSettingsDialog", u"&Cancel", None))
    # retranslateUi
