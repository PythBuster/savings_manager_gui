...
class Ui_AppSettingsDialog(object):
    def setupUi(self, AppSettingsDialog):
        ...
        AppSettingsDialog.resize(457, 247)
        self.verticalLayout = QVBoxLayout(AppSettingsDialog)
        self.verticalLayout.setObjectName("verticalLayout")
        self.frame_app_settings = QFrame(AppSettingsDialog)
        self.frame_app_settings.setObjectName("frame_app_settings")
        self.frame_app_settings.setStyleSheet("border: 0px;")
        ...
        self.formLayout_general_settings.setWidget(
            0, QFormLayout.FieldRole, self.lineEdit_savings_amount
        )

        self.checkBox_enable_automated_savings = QCheckBox(self.frame_app_settings)
        self.checkBox_enable_automated_savings.setObjectName(
            "checkBox_enable_automated_savings"
        )

        self.formLayout_general_settings.setWidget(
            1, QFormLayout.LabelRole, self.checkBox_enable_automated_savings
        )

        self.checkBox_send_reports_via_email = QCheckBox(self.frame_app_settings)
        self.checkBox_send_reports_via_email.setObjectName(
            "checkBox_send_reports_via_email"
        )

        self.formLayout_general_settings.setWidget(
            2, QFormLayout.LabelRole, self.checkBox_send_reports_via_email
        )
        ...
        self.lineEdit_user_email_address.setObjectName("lineEdit_user_email_address")
        self.lineEdit_user_email_address.setStyleSheet("border: 1px solid black;")

        self.formLayout_general_settings.setWidget(
            3, QFormLayout.FieldRole, self.lineEdit_user_email_address
        )
        ...
        self.comboBox_overflow_moneybox_modes.addItem("")
        self.comboBox_overflow_moneybox_modes.addItem("")
        self.comboBox_overflow_moneybox_modes.setObjectName(
            "comboBox_overflow_moneybox_modes"
        )
        self.comboBox_overflow_moneybox_modes.setStyleSheet("border: 1px solid black;")

        self.formLayout_general_settings.setWidget(
            4, QFormLayout.FieldRole, self.comboBox_overflow_moneybox_modes
        )
    ...
    def retranslateUi(self, AppSettingsDialog):
        AppSettingsDialog.setWindowTitle(
            QCoreApplication.translate("AppSettingsDialog", "Dialog", None)
        )
        self.checkBox_enable_automated_savings.setText(
            QCoreApplication.translate(
                "AppSettingsDialog", "Enable Automated Savings", None
            )
        )
        self.checkBox_send_reports_via_email.setText(
            QCoreApplication.translate(
                "AppSettingsDialog", "Send Reports via Email", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "AppSettingsDialog", "User Email Address: ", None
            )
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "AppSettingsDialog", "Overflow Mneybox Mode: ", None
            )
        )
        self.label.setText(
            QCoreApplication.translate("AppSettingsDialog", "Savings Amounts: ", None)
        )
        self.comboBox_overflow_moneybox_modes.setItemText(
            0, QCoreApplication.translate("AppSettingsDialog", "collect", None)
        )
        self.comboBox_overflow_moneybox_modes.setItemText(
            1, QCoreApplication.translate("AppSettingsDialog", "add", None)
        )
        self.comboBox_overflow_moneybox_modes.setItemText(
            2, QCoreApplication.translate("AppSettingsDialog", "fill", None)
        )

        self.pushButton_apply.setText(
            QCoreApplication.translate("AppSettingsDialog", "&Save", None)
        )
        self.pushButton_cancel.setText(
            QCoreApplication.translate("AppSettingsDialog", "&Cancel", None)
        )
