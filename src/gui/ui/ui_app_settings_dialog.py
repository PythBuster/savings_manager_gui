...
class Ui_AppSettingsDialog(object):
    def setupUi(self, AppSettingsDialog):
        ...
        self.formLayout_general_settings.setWidget(3, QFormLayout.LabelRole, self.label_2)
        ...
        self.formLayout_general_settings.setWidget(3, QFormLayout.FieldRole, self.lineEdit_user_email_address)

        self.label_3 = QLabel(self.frame_app_settings)
        self.label_3.setObjectName(u"label_3")

        self.formLayout_general_settings.setWidget(4, QFormLayout.LabelRole, self.label_3)
        ...
        self.formLayout_general_settings.setWidget(4, QFormLayout.FieldRole, self.comboBox_overflow_moneybox_modes)
    ...
    def retranslateUi(self, AppSettingsDialog):
        ...
        self.label_3.setText(QCoreApplication.translate("AppSettingsDialog", u"Overflow Mneybox Mode: ", None))
