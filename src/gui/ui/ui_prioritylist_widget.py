...
class Ui_PriorityListWidget(object):
    def setupUi(self, PriorityListWidget):
        if not PriorityListWidget.objectName():
            PriorityListWidget.setObjectName("PriorityListWidget")
        ...
        self.listWidget_prioritylist.setObjectName("listWidget_prioritylist")
        font1 = QFont()
        font1.setPointSize(12)
        self.listWidget_prioritylist.setFont(font1)
        self.listWidget_prioritylist.setEditTriggers(
    ...
    def retranslateUi(self, PriorityListWidget):
        PriorityListWidget.setWindowTitle(
            QCoreApplication.translate("PriorityListWidget", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate("PriorityListWidget", "Prioritylist", None)
        )
        self.pushButton_selected_up.setText(
            QCoreApplication.translate("PriorityListWidget", "\u25b2", None)
        )
