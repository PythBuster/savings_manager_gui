...
class Ui_MoneyboxesOverviewWidget(object):
    def setupUi(self, MoneyboxesOverviewWidget):
        if not MoneyboxesOverviewWidget.objectName():
            MoneyboxesOverviewWidget.setObjectName("MoneyboxesOverviewWidget")
        ...
        self.gridLayout_moneyboxes.setObjectName("gridLayout_moneyboxes")
        self.gridLayout_moneyboxes.setSizeConstraint(
    ...
    def retranslateUi(self, MoneyboxesOverviewWidget):
        MoneyboxesOverviewWidget.setWindowTitle(
            QCoreApplication.translate("MoneyboxesOverviewWidget", "Form", None)
        )
