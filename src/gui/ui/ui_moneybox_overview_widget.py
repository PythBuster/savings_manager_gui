...
"color: black;")
        ...
        QWidget.setTabOrder(self.pushButton_add_amount, self.pushButton_sub_amount)
        QWidget.setTabOrder(self.pushButton_sub_amount, self.pushButton_transfer_amount)
        QWidget.setTabOrder(self.pushButton_transfer_amount, self.pushButton_settings)
        QWidget.setTabOrder(self.pushButton_settings, self.pushButton_delete_moneybox)
        QWidget.setTabOrder(self.pushButton_delete_moneybox, self.tableWidget_transaction_logs)
