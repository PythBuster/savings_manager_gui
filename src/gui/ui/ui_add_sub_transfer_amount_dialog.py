...
class Ui_AddSubTransferAmountDialog(object):
    def setupUi(self, AddSubTransferAmountDialog):
        ...
        self.comboBox_moneyboxes.setStyleSheet(u"text-align: right; border: 1px solid black;")
        ...
        self.lineEdit_amount.setStyleSheet(u"border: 1px solid black;")
        ...
        self.lineEdit_description.setStyleSheet(u"border: 1px solid black;")
